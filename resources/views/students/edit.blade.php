            ...
            <div class="col-8">
                ...
                <form method="post" action="{{url('students').'/'.$student->id}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" aria-describedby="emailHelp" placeholder="Masukkan Email" name="email" value="{{$student->email}}">
